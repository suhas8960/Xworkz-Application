...
<body>
	...
	<form action="reset" method="post" onsubmit="return validateForm(event)" class="needs-validation" novalidate>
		<div align="center">
			<div class="container">
				<div class="row justify-content-md-center">
					<div class="col col-sm-5">
						<h1 style="color: DarkGreen">ResetPassword</h1>
						<h3 style="color: green">${msg}</h3>
						<div class="form-group">
							<input type="email" class="form-control" id="email" name="email"
								aria-describedby="emailHelp" placeholder="Enter email" class="form-control" required>
						...
						<div class="form-group">
							<input type="text" class="form-control" id="otp"
								placeholder="otp" name="otp" class="form-control" required>
								<div class="invalid-feedback" style="color: red">Please enter a otp.</div>
						</div>
						<input class="btn btn-info" type="Submit" name="Signin.jsp"
							value="Submit" />
					</div>
				</div>
			</div>
