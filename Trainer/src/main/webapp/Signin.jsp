...
<body>
	...
	<form action="singin"  method="get" onsubmit="return validateForm(event)" class="needs-validation" novalidate>
		<div align="center">
			<div class="container">
				<div class="row justify-content-md-center">
					<div class="col col-sm-5">
						<h1 style="color: DarkGreen">SignIn</h1>
						<h3 style="color: Green">${msgs}</h3>
						<h3 style="color: powderblue">${msg}</h3>
						<h3 style="color: powderblue">${match}</h3>
						...
						<input class="btn btn-info" type="Submit" value="sign_in" />
